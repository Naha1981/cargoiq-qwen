...
export function Footer() {
  return (
    <footer className="bg-cargoiq-deep py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex flex-col items-center md:items-start gap-4">
            <Logo size="lg" dark />
            <p className="text-cargoiq-muted text-sm max-w-xs text-center md:text-left">
        ...
        <div className="mt-12 pt-8 border-t border-cargoiq-subtle text-center">
          <p className="text-cargoiq-muted/60 text-sm">
